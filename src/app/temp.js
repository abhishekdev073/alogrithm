...
3. margin :- left space from div; margin 0 auto to center give width
...
7. marign-left :auto it will push all item to left 
...
goes to below to avoid that use clear fix increae parent size fit in 
  .clearfix::after {
  content: "";
  clear: both;
  display: table;
